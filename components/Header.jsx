...
const Header = () => {
  return (
    <header>
      {/* Top Bar */}
      <div className="flex items-center flex-grow px-6 py-4 bg-e_primary">
        ...
        <div className="flex items-center mx-6 space-x-6 text-xs text-white cu whitespace-nowrap">
          <div className="pr-3 border-r link">
            <p>Hello Vladyslav Nechytailo</p>
      ...
      <div className="flex items-center p-2 pl-6 space-x-3 text-sm font-bold text-white bg-accent">
        ...
        <p className="hidden hover:text-accent_yellow link lg:inline-block">Electronics</p>
        <p className="hidden hover:text-accent_yellow link lg:inline-block">Fun</p>
        <p className="hidden hover:text-accent_yellow link lg:inline-block">Travel</p>
        <p className="hidden hover:text-accent_yellow link lg:inline-block">Health & Personal Care</p>
      </div>
    </header>
  );
};
